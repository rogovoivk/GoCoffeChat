...
class TBViewController: UITabBarController, UITabBarControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let navigationPoolPosts = PoolPostsWireframe()
        navigationPoolPosts.postsPoolScreenViewController = item1
        item1.navigation = navigationPoolPosts
//        let interactorPoolPosts = PoolPostsInteractor()
//        interactorPoolPosts.postsPoolScreenViewController = item1
//        item1.interactor = interactorPoolPosts
...
//        let item2 = PoolChatsViewController()
        ...
        let navigationProfile = ProfileWireframe()
        navigationProfile.profileViewController = item3
        item3.navigation = navigationProfile
        let interactorProfile = ProfileInteractor()
        item3.interactor = interactorProfile
